...
export default function NotificationDemo() {
  ...
  const CustomContent = () => (
    <View style={styles.customContent}>
      ...
      <Text style={styles.customText}>That the height is completely flexible</Text>
      <Text style={styles.customText}>And will adapt to any amount of content</Text>
  ...
  return (
    <View style={styles.container}>
      <Button 
        title="Show Success" 
        onPress={() => notification.success("Success", { 
          textColor: 'green',
          shadowColor: 'green',
          borderColor: 'red',
          showShadow: true,
      ...
      <Button 
        title="Show Error" 
        onPress={() => notification.failed("echec", { 
          textColor: '#F44336', 
          shadowColor: '#F44336',
          showShadow: true,
          autoHideDelay: 5000 // 5 seconds
      ...
      <Button 
        title="Show Toaster" 
        onPress={() => notification.toaster("ℹ️ Juste un message", { 
          showShadow: false,
          autoHideDelay: 2000 
        })} 
      />
      ...
      <Button 
        ...
        onPress={() => notification.toaster("This is a longer notification message that will test how the dynamic island handles content with flexible height. The height will adapt to the content.", { 
      ...
      <Button 
        ...
        color="#FF9800"
        onPress={() => notification.showCustom(
          <View style={{ padding: 10 }}>
            <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>Notch Notification</Text>
            <Text style={{ color: 'white' }}>This notification will stay until manually closed</Text>
          </View>, 
          { 
            disableAutoHide: true,
            forceStyle: 'notch'
      ...
      <View style={styles.section}>
        ...
        <Button 
          ...
          color="#3F51B5"
          onPress={() => notification.success("Forced Dynamic Island Style", { 
        ...
        <Button 
          title="Force Notch" 
          color="#009688"
          onPress={() => notification.failed("Forced Notch Style", { 
            forceStyle: 'notch',
            showShadow: true,
            autoHideDelay: 3000
          })} 
        ...
        <Button 
          title="Force Toast" 
          color="#795548"
          onPress={() => notification.toaster("Forced Toast Style", { 
            forceStyle: 'toast',
            showShadow: true,
            autoHideDelay: 3000
          })} 
